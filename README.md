...
```shell
https://api.dler.io/sub?target=clash&new_name=true&url=你的订阅链接（URL编码）[&config=https%3A%2F%2Fraw.githubusercontent.com%2FWyatt323%2Fopenclash-rules%2Fmain%2FACL4SSR_Online_Full.ini](https://raw.githubusercontent.com/cjlhll/openclash-rules/main/ACL4SSR_Online_Full.ini)
```  
方法二：  
