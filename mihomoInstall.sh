...
curl -s -L -o "$tarball" "https://ghfast.top/https://github.com/nikkinikki-org/OpenWrt-nikki/releases/latest/download/$tarball"
#curl -s -L -o "$tarball" "https://testingcf.jsdelivr.net/gh/cjlhll/openclash-rules@release/$tarball"
